    ...
    <div className="my-10 mb-20">
      <div className="py-10 px-20 border border-blue-200 rounded-xl max-w-xl mx-auto">
        ...
        >
          ...
          <button
            type="submit"
            className="btn btn-outline btn-info my-5 bg-blue-200 px-10"
          >
            Submit
          </button>
          <p className="text-sm">
            Already have an account ?{" "}
            <Link to="/login" className="text-blue-400 link">
              Log in
            </Link>
          </p>
          <div className="divider">or</div>
          <SocialLogin></SocialLogin>
          {/* <button className="btn btn-outline btn-info px-10 mx-auto">
            <FcGoogle />
            Sign in with Google
          </button> */}
        </form>
